...
-- Dumping data for table kntl.vyzo_giveaway_code: ~2 rows (approximately)
/*!40000 ALTER TABLE `vyzo_giveaway_code` DISABLE KEYS */;
/*!40000 ALTER TABLE `vyzo_giveaway_code` ENABLE KEYS */;

-- Dumping structure for table kntl.vyzo_giveaway_log
...
-- Dumping data for table kntl.vyzo_giveaway_log: ~0 rows (approximately)
